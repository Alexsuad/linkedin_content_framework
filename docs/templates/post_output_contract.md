...
*   **fuente_principal:** [Origen del dato: Reunión de soporte, caso de éxito, nota comercial]
...
*   **audiencia_objetivo:** [Buyer Persona o perfil profesional de destino en LinkedIn]
...
*   **tipo_de_conversacion_esperada:** [Ej: Debate técnico en comentarios, leads por mensaje privado]
...
*   **fecha_limite_revision:** [Fecha y hora límite sugerida para la firma, AAAA-MM-DD HH:MM]

## 9. Decisión final
*   **decision:** [Aprobado / Devuelto para ajustes / Rechazado y Descartado]
*   **aprobado_por:** [Firma del responsable humano del perfil]
...
Cualquier borrador que no cumpla con estos mínimos será clasificado automáticamente como `BLOCKED_BY_FORMAT_RISK` y devuelto al redactor antes de entrar en los gates de gobernanza.
